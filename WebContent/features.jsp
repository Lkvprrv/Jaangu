...
<!-- Mirrored from codenpixel.com/demo/kupon/features.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Dec 2015 06:59:47 GMT -->
<head>
          ...
          <div class="col-sm-8">
            <div class="panel-body frameLR bg-white shadow mTop-30">
              ...
              <div class="bs-example bs-example-type">
                ...
                <hr data-symbol="Pagination">
                <nav>
  <ul class="pagin list-inline">
    <li class="btn btn-xs btn-raised ripple-effect">
      <a href="#" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
    <li class="btn btn-xs btn-raised ripple-effect"><a href="#">1</a></li>
    <li class="btn btn-xs btn-raised ripple-effect"><a href="#">2</a></li>
    <li class="btn btn-xs btn-raised ripple-effect"><a href="#">3</a></li>
    <li class="btn btn-xs btn-raised ripple-effect"><a href="#">4</a></li>
    <li class="btn btn-xs btn-raised ripple-effect"><a href="#">5</a></li>
    <li class="btn btn-xs btn-raised ripple-effect">
          ...
          <div class="col-sm-4 sidebar">
            <div class="inner-side shadow">
              <div class="widget widget-add">
                ...
                <img src="images/add-1.jpg" alt="add" class="img-responsive">
              </div>
