                    ...
                    <div class="buyPanel animated fadeIn bg-white Aligner shadow">
                      <div class="content">
                        ...
                        <ul class="deal-price list-unstyled list-inline">
                          ...
                          <li class="buy-now">
                            <a href="details.jsp" class="btn btn-success btn-raised ripple-effect">
                              BUY NOW
                            </a>
                          </li>
                        </ul>
                    ...
                    <div class="buyPanel animated fadeInLeft bg-white bordered Aligner">
                      <div class="content">
                        ...
                        <ul class="deal-price list-unstyled list-inline">
                          ...
                          <li class="buy-now">
                            <a href="details.jsp"  class="btn btn-primary btn-raised ripple-effect">
                              BUY NOW
                            </a>
                          </li>
                        </ul>
                ...
                <div class="deal-entry green">
                  ...
                  <footer class="info_bar clearfix">
                    <ul class="unstyled list-inline row">
                      ...
                      <li class="info_link col-sm-5 col-xs-6 col-lg-4">
                        <a style="padding:4px 5px;" href="details.jsp" class="btn btn-block btn-default btn-raised btn-sm">
                          View Deal
                        </a>
                      </li>
                    </ul>
